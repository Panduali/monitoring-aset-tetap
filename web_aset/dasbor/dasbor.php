...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
              ...
              <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo $shutdownCount; ?></span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
              ...
              <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo $penghapusanCount; ?></span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
              ...
              <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo $aktifCount; ?></span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-footer p-0">
                    <ul class="nav nav-pills flex-column">
                      ...
                      $detailQuery = "SELECT status_aset, COUNT(*) as total_count FROM import_dat WHERE status_aset IS NOT NULL AND status_aset != '' GROUP BY status_aset ORDER BY total_count DESC LIMIT 6";
                      ...
                      $colorClasses = ['text-primary', 'text-success', 'text-warning', 'text-danger', 'text-info', 'text-secondary'];
                      $colorStatus = ['text-success', 'text-danger', 'text-info'];
                      
                      foreach ($details as $index => $detail) {
                          $colorClass = $colorStatus[$index % 3];
                          $statusName = htmlspecialchars($detail['status_aset']);
                          ...
                          <li class="nav-item">
                            <a href="#" class="nav-link">
                              ...
                              <span class="float-end <?php echo $colorClass; ?>">
                                <i class="bi <?php echo [$index % 3]; ?> fs-7"></i>
                                <?php echo $count; ?>
                              </span>
                            </a>
                          </li>
    ...
    <script>
      ...
      <?php
      // Get data from database for pie chart - grouped by status_aset
      $statusQuery = "SELECT status_aset, COUNT(*) as count FROM import_dat WHERE status_aset IS NOT NULL AND status_aset != '' GROUP BY status_aset ORDER BY count DESC LIMIT 6";
      ...
      if ($statusResult && mysqli_num_rows($statusResult) > 0) {
          while ($row = mysqli_fetch_assoc($statusResult)) {
              $labels[] = htmlspecialchars($row['status_aset']);
              $data[] = (int)$row['count'];
          }
      }
      ...
      const pie_chart_options = {
        ...
        xaxis: {
          categories: <?php echo $labelsJson; ?>,
        },
        yaxis: {
          title: {
            text: 'Jumlah Aset'
        ...
        colors: ['#0d6efd', '#20c997', '#ffc107', '#d63384', '#6f42c1', '#adb5bd', '#fd7e14', '#6c757d'],
      };
